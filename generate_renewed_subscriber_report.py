...
REPLACEMENTS = {
    ...
    'fig_q9_overall.update_layout(yaxis_tickformat=".0%", xaxis_tickangle=-30)': 'fig_q9_overall.update_layout(yaxis_tickformat=".0%", xaxis_tickangle=-30, xaxis_tickfont_size=10, margin=dict(b=130))',
}
...
POST_REPLACEMENTS = {
    ...
    "I feel more exclusive/recognized with the Plus badge on my profile": "Feeling more exclusive with Plus badge",
